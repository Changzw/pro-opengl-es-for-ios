//
//  GLKReflectionMapViewController.m
//  GLKReflectionMap
//
...
@interface GLKReflectionMapViewController () {
    GLuint _program;
...
@implementation GLKReflectionMapViewController
...
- (void)setupGL
{
    ...
    self.effect.light0.enabled = GL_TRUE;			//4
    ...
    m_Earth=[[Planet alloc] init:planetSize slices:planetSize radius:.5f squash:1.0f 
...
- (void)update
{
    ...
    self.effect.matrix=GLKMatrix3Identity;
